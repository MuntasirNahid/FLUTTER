...
class ResetStudentEmailSentScreen extends StatefulWidget {
  ...
  const ResetStudentEmailSentScreen({super.key, required this.email});

  @override
  State<ResetStudentEmailSentScreen> createState() =>
      _ResetStudentEmailSentScreenState();
}

class _ResetStudentEmailSentScreenState
    extends State<ResetStudentEmailSentScreen> {
  @override
